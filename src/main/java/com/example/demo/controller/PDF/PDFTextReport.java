...
//4.向文档中添加内容
//通过 com.lowagie.text.Paragraph 来添加文本。可以用文本及其默认的字体、颜色、大小等等设置来创建一个默认段落
        Paragraph pt=new Paragraph("zhong:-"+title,headfont);//设置字体样式
        pt.setAlignment(Element.KEYWORDS);//设置文字居中 0靠左   1，居中     2，靠右
        document.add(pt);
        document.add(new Paragraph("\n"));
...
//5.关闭文档
    ...
    public static void main(String[] args) throws Exception {
        ...
        PDFTextReport ppt=new PDFTextReport();
